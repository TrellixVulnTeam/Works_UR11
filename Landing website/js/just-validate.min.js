...
function(e) {
    ...
    f.prototype = {
        ...
        defaultMessages: { required: "Поле обязательно для заполнения", email: "Пожалуйса, введите корректный адрес", maxLength: "Поле должно содержать максимум :value символов", minLength: "Поле должно содержать минимум :value символа", password: "Password is not valid", remote: "Email already exists", strength: "Password must contents at least one uppercase letter, one lowercase letter and one number", "function": "Function returned false" },
